...
import '../eye_brands_widgets/filters.dart';
import 'filter_simulation_page.dart';

class CountryDialogSimPage extends StatefulWidget {
  CountryDialogSimPage({Key? key}) : super(key: key);

  @override
  State<CountryDialogSimPage> createState() => _CountryDialogSimPageState();
}

class _CountryDialogSimPageState extends State<CountryDialogSimPage> {
  @override
  void dispose() {
    super.dispose();
  }
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (c, i) => Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(categories[i][0], style: textStyle(i)),
                                Checkbox(
